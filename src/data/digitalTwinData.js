const digitalTwinData = {
  definition: {
    ...
    brandNote: 'التوائم الرقمية للشركات والمصانع هي البراند الرئيسي لشركة شبلونة ومصدر الإيرادات الأساسي. يتميز هذا البراند عن شبلونات تحتمس وماعت — التي تخدم أيضاً الشركات والمصانع بالإضافة لصناع القرار من الخبراء والنقاد والجمهور (B2C) — بتركيزه الكامل على حلول B2B للمؤسسات الصناعية.',
