const homeData = {
  hero: {
    ...
    description:
      'نصمم ونطور برمجيات التوائم الرقمية وأنظمة المحاكاة والذكاء الاصطناعي مع حلول التحول الرقمي المتكاملة للمؤسسات الصناعية وصناع القرار',
    primaryBtn: {
  ...
  brandsPreview: {
    title: 'عائلة شبلونة - خمسة براندات',
    subtitle:
      'خمسة براندات فرعية مشتقة من حلزون فيبوناتشي الأم، كل منها يحمل DNA شبلونة مع تخصص فريد',
    brands: [
      {
        name: 'تحتمس الثالث',
        color: '#C0392B',
